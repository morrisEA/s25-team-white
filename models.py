...
class Watch(models.Model):
    ...
    check_out_time = models.DateTimeField(null=True, blank=True)  # Track actual check-out time
    check_in_time = models.DateTimeField(null=True, blank=True)  # Track actual check-in time
